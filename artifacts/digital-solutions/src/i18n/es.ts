...
export const es: Translations = {
  ...
  crmSync: {
    ...
    auditClose: "Cerrar",
    auditTitle: "API Payload (Simulación)",
    auditNote: "Este es un payload simulado. En un sistema en vivo, esta solicitud se enviaría a su API de CRM.",
    logicLabel: "Verificación lógica",
    logicRule: "IF presupuesto > 5.000 € → Prioridad: Alta",
    impactTitle: "Efecto",
