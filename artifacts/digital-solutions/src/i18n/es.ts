...
export const es: Translations = {
  ...
  crmSync: {
    ...
    sandboxBadge: "Sandbox · Sin llamadas externas",
    auditBtn: "Mostrar auditoría técnica",
    auditClose: "Cerrar",
    ...
    logicLabel: "Motor de reglas",
    logicRule: "IF presupuesto > 5.000 € → Prioridad: Alta",
    impactTitle: "Impacto medible",
    impactText: "100 % datos consistentes · aprox. 15 min. de ahorro por lead",
    ctaAudit: "Solicitar auditoría CRM",
  },
  qualifier: {
