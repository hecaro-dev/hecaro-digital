...
export const de = {
  ...
  qualifier: {
    ...
    resultSub: "Basierend auf Ihren Angaben hat die KI folgende Einschätzung getroffen:",
    gradeA: "Qualifizierter Lead",
    gradeADesc: "Ihre Anfrage passt genau zum Profil, für das ich meine Premium-Lösung entwickelt habe. Ein direktes Gespräch lohnt sich.",
    gradeB: "Informationsbedarf",
    gradeBDesc: "Ich empfehle zunächst ein kostenloses Erstgespräch, um den besten Ansatz für Ihre Situation zu finden.",
