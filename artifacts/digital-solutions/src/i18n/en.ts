...
export const en: Translations = {
  ...
  targetGroup: {
    ...
    text: "Ideal for B2B agencies, coaches and service providers who regularly receive enquiries and no longer want to waste time on unsuitable leads.",
  },
  values: {
    label: "My Values",
  ...
  techstack: {
    ...
    items: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Intelligent Filter", "Nodemailer"],
  },
  process: {
    label: "Process",
    headline: "My Process",
  ...
  qualifier: {
    ...
    sub: "Qualify enquiries automatically in 4 steps — and save valuable time.",
    steps: [
    ...
    gradeABulletEngpass: "Budget: Investment readiness confirmed",
    gradeABulletImpact: "Decision-maker: Authority confirmed",
    gradeABulletBudget: "Urgency: Immediate need identified",
    gradeAFitTitle: "Recommendation",
    gradeARecommendation: "Recommendation: Schedule an immediate callback",
    ctaA: "I want this for my business",
