...
export default function Footer({ onLegal }: FooterProps) {
  ...
  return (
    <footer
      className="border-t border-slate-800/60 py-10 px-4"
      role="contentinfo"
    >
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <nav className="flex items-center gap-4" aria-label="Legal navigation">
          <button
            ...
            className="text-xs text-slate-500 hover:text-slate-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
          >
            {t.nav.imprint}
          </button>
          <button
