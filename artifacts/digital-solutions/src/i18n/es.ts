...
export const es: Translations = {
  ...
  portfolio: {
    ...
    items: [
      ...
      {
        tag: "CRM Automation",
        title: "Demo Lead-to-CRM Sync",
        description:
          "El problema: los leads cualificados acaban en la bandeja de entrada en lugar de ir directamente al CRM. Esta demo muestra cómo un pipeline de automatización categoriza leads en tiempo real y los inyecta en el CRM.",
        problem: "Entrada manual de datos CRM tras la cualificación",
        ctaLabel: "Iniciar demo →",
      },
    ],
  ...
  crmSync: {
    badge: "Demo IA · CRM Automation",
    headline: "Del lead cualificado\nal CRM – completamente automático",
    sub: "Vea en vivo cómo una solicitud cualificada se procesa en 3 pasos y se inyecta directamente en el CRM.",
    step1Label: "Datos entrantes",
    step2Label: "Análisis IA",
    step3Label: "Inyección CRM",
    idleStatus: "Esperando lead cualificado...",
    processingStatus: "Análisis IA y mapeo CRM en curso...",
    successStatus: "Sincronización exitosa. Entrada CRM creada.",
    triggerBtn: "Activar sincronización",
    restartBtn: "Reiniciar",
    rawDataTitle: "Datos brutos (Entrada)",
    processingTitle: "Procesamiento IA",
    crmTitle: "Entrada CRM · Recién creada",
    ...
    demoNote: "Demo en vivo del pipeline de automatización CRM — implementable en su stack tecnológico existente.",
