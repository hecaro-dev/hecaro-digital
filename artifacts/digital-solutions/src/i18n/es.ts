...
export const es: Translations = {
  ...
  targetGroup: {
    ...
    headline: "¿Para quién es esto?",
    text: "Ideal para agencias B2B, coaches y proveedores de servicios que reciben consultas regularmente y no quieren seguir perdiendo tiempo con leads inadecuados.",
  },
  values: {
    label: "Mis valores",
  ...
  techstack: {
    ...
    items: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Filtro Inteligente", "Nodemailer"],
  },
  process: {
    label: "Proceso",
    headline: "Mi Proceso",
  ...
  contact: {
    ...
    send: "Solicitar consulta gratuita",
    sending: "Enviando...",
  ...
  qualifier: {
    ...
    sub: "Cualifique solicitudes de forma automática en 4 pasos — y ahorre tiempo valioso.",
    steps: [
    ...
    gradeABulletEngpass: "Presupuesto: Disposición de inversión confirmada",
    gradeABulletImpact: "Decisor: Autoridad de decisión confirmada",
    gradeABulletBudget: "Urgencia: Necesidad inmediata identificada",
    gradeAFitTitle: "Recomendación",
    gradeARecommendation: "Recomendación: Programar una llamada inmediata",
    ctaA: "Quiero esto para mi negocio",
    ...
    heroCta: "Probar demo",
    servicesLink: "PROBAR DEMO GRATIS",
