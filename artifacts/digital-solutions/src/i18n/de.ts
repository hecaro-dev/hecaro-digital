...
export const de = {
  ...
  contact: {
    label: "Kontakt",
    headline: "Zeitverschwendung beenden?",
    cta: "Bereit für qualifiziertere Anfragen?",
    sub: "Beschreiben Sie kurz Ihre aktuelle Situation – ich melde mich mit einem konkreten Automatisierungs-Plan.",
    ...
    send: "Kostenloses Erstgespräch anfragen",
  ...
  projectCheck: {
    ...
    headline: "Präzise Projekt-Briefings statt Chaos",
    sub: "Lassen Sie Interessenten Ihr Projekt so beschreiben, dass Sie sofort ein Angebot erstellen können.",
    bullets: [
