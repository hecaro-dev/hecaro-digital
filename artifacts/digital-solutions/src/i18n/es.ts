...
export const es: Translations = {
  ...
  qualifier: {
    ...
    resultSub: "Basándose en sus datos, la IA ha hecho la siguiente valoración:",
    gradeA: "Lead cualificado",
    gradeADesc: "Su solicitud se ajusta exactamente al perfil para el que he desarrollado mi solución premium. Vale la pena una conversación directa.",
    gradeB: "Necesita información",
    gradeBDesc: "Recomiendo comenzar con una consulta inicial gratuita para encontrar el mejor enfoque para su situación.",
    summary: "Resumen IA",
