...
export const en: Translations = {
  ...
  qualifier: {
    ...
    resultSub: "Based on your input, the AI has made the following assessment:",
    gradeA: "Qualified Lead",
    gradeADesc: "Your enquiry fits exactly the profile for which I have developed my premium solution. A direct conversation is worthwhile.",
    gradeB: "Information Needed",
    gradeBDesc: "I recommend starting with a free initial consultation to find the best approach for your situation.",
    summary: "AI Summary",
